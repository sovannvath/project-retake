...
class ApiClient {
  ...
  async updateUserProfile(userData) {
    return this.makeRequest("/user", "PUT", userData);
  }

  async changePassword(passwordData) {
    return this.makeRequest("/user/password", "PUT", passwordData);
  }

  async updateUserPreferences(preferences) {
    return this.makeRequest("/user/preferences", "PUT", preferences);
  }
  ...
  async addToCart(productId, quantity) {
    return this.makeRequest("/cart/add", "POST", {
  ...
  async updateOrderStatus(id, status) {
    return this.makeRequest(`/orders/${id}/status`, "PUT", {
      order_status: status,
    });
  }

  async updatePaymentStatus(id, status) {
    return this.makeRequest(`/orders/${id}/payment`, "PUT", {
  ...
  async adminApproval(id, approvalData) {
    return this.makeRequest(
      `/request-orders/${id}/admin-approval`,
      "PUT",
      approvalData,
    );
  }
  ...
  async updateRequestOrderAdminApproval(id, approved) {
    return this.makeRequest(`/request-orders/${id}/admin-approval`, "PUT", {
      approved,
    });
  }

  async updateRequestOrderWarehouseApproval(id, approved) {
    return this.makeRequest(`/request-orders/${id}/warehouse-approval`, "PUT", {
      approved,
    });
  }
